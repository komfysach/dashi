...
export const EditorData = () => (
  <div>
    <h3>
      Hi! My name is Sachin, welcome to the Dashi app. A all-in-one dashboard app for your business.

      Features include, this rich text editor, kanban board for your tasks, calendar for your appointments, and many more features for you to use
      in your day-to-day business activities.

      This app was developed using React, Tailwind and with the help of the Synfusion library for these awesome features.

      If you would like to see more of my work, head over to my website sachinlendis.dev - looking forward to hearing from you.
