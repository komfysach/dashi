...
const NavBar = () => {
  ...
  //use checked screenSize to determine if less that 900px
  useEffect(() => {
    if(screenSize <= 900) {
      setActiveMenu(false)
    } else {
  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative z-0'>
      ...
      <div className='flex'>
        ...
        />
        <NavButton
        title="Notifications" customFunc={() => handleClick('notification')}
        color={currentColor} 
        dotColor="#03C9D7"
